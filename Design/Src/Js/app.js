...
function TransfeFrom() {
    ...
    MyContract.methods.transferFrom(addressfrom, addressto, amount).send({from : CurrentAccount}).then(function (Instanse) {
        ...
        alert(Instanse.events.Approval.returnValues[2]/100 + ' Tokens from' + 
        Instanse.events.Approval.returnValues[0] + ' Approved To ' + Instanse.events.Approval.returnValues[1]);
...
function transfer() {
    ...
    MyContract.methods.transfer(address, amount).send({from : CurrentAccount}).then(function (Instanse) {
        ...
        alert(Instanse.events.Transfer.returnValues[2]/100 + ' Tokens from ' + 
...
function mint() {
  ...
  /*  var txparam = {
    ...
    MyContract.methods.mint(amount).send({from : CurrentAccount}).then(function (Instance) {
